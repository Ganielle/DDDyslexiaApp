...
public class GuardianLogin : MonoBehaviour
{
    ...
    [SerializeField] private GameObject guardianObj;
    [SerializeField] private GameObject guardianIntro;
    [SerializeField] private GameObject guardianMenu;
    ...
    public void Logout()
    {
        notificationController.ShowConfirmation("Are you sure you want to logout?", () =>
        {
            ...
            guardianIntro.SetActive(true);
            guardianMenu.SetActive(false);
    ...
    {
        UnityWebRequest apiRquest = UnityWebRequest.Get($"{apiController.url}/auth/loginparent?username={usernameTMP.text}&password={passwordTMP.text}");
